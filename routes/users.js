 ...
 *
 * Helper function sqlPartialUpdate updated to throw error if admin is included in fields to be updated.
 */
...
router.patch('/:username', authUser, requireLogin, //requireAdmin, 
  ...
  try {
    ///might have to remove requireAdmin from middleware here because this handles cases of a non-admin user.
